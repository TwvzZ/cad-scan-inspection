...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "C:/Program Files/Boost/include/boost-1_84")
  endif()

  include(${CMAKE_CURRENT_LIST_DIR}/Modules/AdditionalBoostVersions.cmake)
  set(Boost_ADDITIONAL_VERSIONS "1.84.0" "1.84" ${Boost_ADDITIONAL_VERSIONS})
  
  find_package(Boost 1.65.0 ${QUIET_} COMPONENTS system iostreams filesystem serialization)
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "C:/Program Files/VTK/lib/cmake/vtk-9.3" CACHE PATH "The directory containing VTKConfig.cmake")
  endif()
  if(NOT ANDROID)
...
list(APPEND PCL_DEFINITIONS  -D__SSE4_2__ -D__SSE4_1__ -D__SSSE3__ -D__SSE3__ -D__SSE2__ -D__SSE__ -DEIGEN_HAS_CXX17_OVERALIGN=0)
list(APPEND PCL_COMPILE_OPTIONS )

#set AVX flags used compiling PCL
list(APPEND PCL_COMPILE_OPTIONS /arch:AVX2)
...
set(pcl_io_opt_dep openni2 vtk OpenMP )
